...
const BookingsTable = () => {
    ...
    const { bookings, selectedBooking, page, pageSize, totalPages, openModal, loading: bookingLoading, handleViewBooking, handlePayment, handleCancelBooking, handleCloseModal, onPageChange } = useBookings(1);
